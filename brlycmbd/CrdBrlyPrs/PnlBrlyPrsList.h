/**
  ...
  * job handler for job PnlBrlyPrsList (declarations)
...
/**
  * PnlBrlyPrsList
  */
class PnlBrlyPrsList : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQPrsList* rst = NULL, QryBrlyPrsList::StatShr* statshrqry = NULL, QryBrlyPrsList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyPrsList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyPrsList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyPrsList::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
