/**
  * \file PnlBrlyPrsHeadbar_blks.cpp
  * job handler for job PnlBrlyPrsHeadbar (implementation of blocks)
...
void PnlBrlyPrsHeadbar::StgInf::writeXML(
	...
	else itemtag = "StgitemInfBrlyPrsHeadbar";
...
void PnlBrlyPrsHeadbar::Tag::writeXML(
	...
	else itemtag = "TagitemBrlyPrsHeadbar";
...
PnlBrlyPrsHeadbar::DpchEngData::DpchEngData(
			const ubigint jref
			, const set<uint>& mask
		) : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYPRSHEADBARDATA, jref) {
...
void PnlBrlyPrsHeadbar::DpchEngData::merge(
			DpchEngBrly* dpcheng
		) {
...
void PnlBrlyPrsHeadbar::DpchEngData::writeXML(
	...
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngBrlyPrsHeadbarData");
