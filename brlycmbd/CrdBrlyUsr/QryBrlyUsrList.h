/**
  ...
  * job handler for job QryBrlyUsrList (declarations)
...
/**
  * QryBrlyUsrList
  */
class QryBrlyUsrList : public JobBrly {
...
public:
	QryBrlyUsrList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~QryBrlyUsrList();
...
public:
	...
	BrlyQUsrList* getRecByJnum(const uint jnum);
...
public:
	...
	bool handleCallBrlyUsrMod(DbsBrly* dbsbrly, const ubigint jrefTrig);
