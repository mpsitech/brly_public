/**
  ...
  * job handler for job PnlBrlyUsrAAccess (declarations)
...
/**
  * PnlBrlyUsrAAccess
  */
class PnlBrlyUsrAAccess : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQUsrAAccess* rst = NULL, QryBrlyUsrAAccess::StatShr* statshrqry = NULL, QryBrlyUsrAAccess::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyUsrAAccess(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyUsrAAccess();
...
public:
	...
	QryBrlyUsrAAccess* qry;

	BrlyAMUserAccess recUsrAacc;
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyUsrAAccess::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
