/**
  ...
  * job handler for job PnlBrlyLegList (declarations)
...
/**
  * PnlBrlyLegList
  */
class PnlBrlyLegList : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLegList* rst = NULL, QryBrlyLegList::StatShr* statshrqry = NULL, QryBrlyLegList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyLegList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyLegList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyLegList::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
