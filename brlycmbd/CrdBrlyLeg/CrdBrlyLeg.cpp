...
void CrdBrlyLeg::changeRef(
	...
	uint ixBrlyVAccess;
	xchg->triggerIxRefToIxCall(dbsbrly, VecBrlyVCall::CALLBRLYACCESS, jref, VecBrlyVMaintable::TBLBRLYMLEG, ref, ixBrlyVAccess);
