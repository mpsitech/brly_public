...
void QryBrlyLeg1NFlight::rerun(
	...
	xchg->addRefClstn(VecBrlyVCall::CALLBRLYFLTMOD_LEGEQ, jref, Clstn::VecVJobmask::ALL, 0, preRefLeg, Clstn::VecVJactype::LOCK);
};
...
void QryBrlyLeg1NFlight::handleCall(
	...
	} else if (call->ixVCall == VecBrlyVCall::CALLBRLYFLTMOD_LEGEQ) {
		call->abort = handleCallBrlyFltMod_legEq(dbsbrly, call->jref, call->argInv.ref);
	};
};

bool QryBrlyLeg1NFlight::handleCallBrlyStubChg(
			DbsBrly* dbsbrly
