/**
  ...
  * job handler for job PnlBrlyOpr1NEquipment (declarations)
...
/**
  ...
  */
class PnlBrlyOpr1NEquipment : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQOpr1NEquipment* rst = NULL, QryBrlyOpr1NEquipment::StatShr* statshrqry = NULL, QryBrlyOpr1NEquipment::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyOpr1NEquipment(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyOpr1NEquipment();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyOpr1NEquipment::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
