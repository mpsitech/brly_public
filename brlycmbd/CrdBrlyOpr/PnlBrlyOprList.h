/**
  ...
  * job handler for job PnlBrlyOprList (declarations)
...
/**
  * PnlBrlyOprList
  */
class PnlBrlyOprList : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQOprList* rst = NULL, QryBrlyOprList::StatShr* statshrqry = NULL, QryBrlyOprList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyOprList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyOprList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyOprList::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
