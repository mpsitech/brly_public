/**
  ...
  * job handler for job PnlBrlyOprHeadbar (declarations)
...
/**
  * PnlBrlyOprHeadbar
  */
class PnlBrlyOprHeadbar : public JobBrly {
...
public:
	PnlBrlyOprHeadbar(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyOprHeadbar();
