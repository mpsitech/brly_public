/**
  * \file QryBrlyFlt1NConnection_blks.cpp
  * job handler for job QryBrlyFlt1NConnection (implementation of blocks)
...
void QryBrlyFlt1NConnection::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryBrlyFlt1NConnection";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemAppQryBrlyFlt1NConnection";
...
void QryBrlyFlt1NConnection::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StatShrQryBrlyFlt1NConnection";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryBrlyFlt1NConnection";
