/**
  * \file QryBrlyFltEqp1NNode_blks.cpp
  * job handler for job QryBrlyFltEqp1NNode (implementation of blocks)
...
void QryBrlyFltEqp1NNode::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryBrlyFltEqp1NNode";
...
void QryBrlyFltEqp1NNode::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryBrlyFltEqp1NNode";
