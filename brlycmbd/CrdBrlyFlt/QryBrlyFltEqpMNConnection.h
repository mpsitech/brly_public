...
public:
	QryBrlyFltEqpMNConnection(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~QryBrlyFltEqpMNConnection();
...
public:
	...
	BrlyQFltEqpMNConnection* getRecByJnum(const uint jnum);
