/**
  ...
  * job handler for job PnlBrlyFltList (declarations)
...
/**
  * PnlBrlyFltList
  */
class PnlBrlyFltList : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQFltList* rst = NULL, QryBrlyFltList::StatShr* statshrqry = NULL, QryBrlyFltList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyFltList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyFltList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyFltList::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
