...
void QryBrlyFltRef1NSegment::rerun(
	...
	xchg->addIxRefClstn(VecBrlyVCall::CALLBRLYSEGMOD_RETREUEQ, jref, Clstn::VecVJobmask::ALL, 0, VecBrlyVMSegmentRefTbl::FLT, preRefFlt, Clstn::VecVJactype::LOCK);
};
...
bool QryBrlyFltRef1NSegment::handleCallBrlyStubChg(
			DbsBrly* dbsbrly
