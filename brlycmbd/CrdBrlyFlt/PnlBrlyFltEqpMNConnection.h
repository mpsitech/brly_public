/**
  ...
  * job handler for job PnlBrlyFltEqpMNConnection (declarations)
...
/**
  ...
  */
class PnlBrlyFltEqpMNConnection : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQFltEqpMNConnection* rst = NULL, QryBrlyFltEqpMNConnection::StatShr* statshrqry = NULL, QryBrlyFltEqpMNConnection::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyFltEqpMNConnection(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyFltEqpMNConnection();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyFltEqpMNConnection::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
