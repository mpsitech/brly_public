/**
  ...
  * job handler for job PnlBrlyFltMNLocation (declarations)
...
/**
  ...
  */
class PnlBrlyFltMNLocation : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQFltMNLocation* rst = NULL, QryBrlyFltMNLocation::StatShr* statshrqry = NULL, QryBrlyFltMNLocation::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyFltMNLocation(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyFltMNLocation();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyFltMNLocation::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
