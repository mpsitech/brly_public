/**
  * \file CrdBrlyReg.h
  * job handler for job CrdBrlyReg (declarations)
...
#define VecVBrlyRegDo CrdBrlyReg::VecVDo
#define VecVBrlyRegSge CrdBrlyReg::VecVSge

#define ContInfBrlyReg CrdBrlyReg::ContInf
#define StatAppBrlyReg CrdBrlyReg::StatApp
#define StatShrBrlyReg CrdBrlyReg::StatShr
#define TagBrlyReg CrdBrlyReg::Tag

#define DpchAppBrlyRegDo CrdBrlyReg::DpchAppDo
#define DpchEngBrlyRegData CrdBrlyReg::DpchEngData

/**
  * CrdBrlyReg
  */
class CrdBrlyReg : public JobBrly {

public:
	/**
		* VecVDo (full: VecVBrlyRegDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDREG = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdReg = "");
	...
	/**
		* DpchAppDo (full: DpchAppBrlyRegDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngBrlyRegData)
		*/
...
public:
	CrdBrlyReg(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale, const ubigint ref = 0);
	~CrdBrlyReg();
...
public:
	...
	PnlBrlyRegRec* pnlrec;
	PnlBrlyRegHeadbar* pnlheadbar;
	PnlBrlyRegList* pnllist;
