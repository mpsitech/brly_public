/**
  * \file PnlBrlyRegADstswitch_blks.cpp
  * job handler for job PnlBrlyRegADstswitch (implementation of blocks)
...
void PnlBrlyRegADstswitch::ContInf::writeXML(
	...
	else itemtag = "ContitemInfBrlyRegADstswitch";
...
void PnlBrlyRegADstswitch::StatApp::writeXML(
	...
	else itemtag = "StatitemAppBrlyRegADstswitch";
...
void PnlBrlyRegADstswitch::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrBrlyRegADstswitch";
...
void PnlBrlyRegADstswitch::Tag::writeXML(
	...
	else itemtag = "TagitemBrlyRegADstswitch";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixBrlyVLocale == VecBrlyVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "DST switches");
			writeStringAttr(wr, itemtag, "sref", "TcoStd", "Date");
			writeStringAttr(wr, itemtag, "sref", "TcoStt", "Time");
		} else if (ixBrlyVLocale == VecBrlyVLocale::DECH) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Sommerzeit-Wechsel");
			writeStringAttr(wr, itemtag, "sref", "TcoStd", "Datum");
			writeStringAttr(wr, itemtag, "sref", "TcoStt", "Uhrzeit");
		};
...
PnlBrlyRegADstswitch::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYREGADSTSWITCHDATA) {
};
...
void PnlBrlyRegADstswitch::DpchAppData::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppBrlyRegADstswitchData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlBrlyRegADstswitch::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYREGADSTSWITCHDO) {
	ixVDo = 0;
};
...
void PnlBrlyRegADstswitch::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppBrlyRegADstswitchDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlBrlyRegADstswitch::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, const set<uint>& mask
		) : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYREGADSTSWITCHDATA, jref) {
...
void PnlBrlyRegADstswitch::DpchEngData::merge(
			DpchEngBrly* dpcheng
		) {
...
void PnlBrlyRegADstswitch::DpchEngData::writeXML(
	...
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngBrlyRegADstswitchData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/brly");
		...
		if (has(STATAPPQRY)) QryBrlyRegADstswitch::StatApp::writeXML(wr);
