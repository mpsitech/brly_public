/**
  ...
  * job handler for job PnlBrlyRegSup1NRegion (declarations)
...
/**
  ...
  */
class PnlBrlyRegSup1NRegion : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQRegSup1NRegion* rst = NULL, QryBrlyRegSup1NRegion::StatShr* statshrqry = NULL, QryBrlyRegSup1NRegion::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyRegSup1NRegion(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyRegSup1NRegion();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyRegSup1NRegion::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
