/**
  ...
  * job handler for job PnlBrlyUsgList (declarations)
...
/**
  * PnlBrlyUsgList
  */
class PnlBrlyUsgList : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQUsgList* rst = NULL, QryBrlyUsgList::StatShr* statshrqry = NULL, QryBrlyUsgList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyUsgList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyUsgList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyUsgList::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
