...
public:
	QryBrlyUsgList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~QryBrlyUsgList();
...
public:
	...
	BrlyQUsgList* getRecByJnum(const uint jnum);
...
public:
	...
	bool handleCallBrlyUsgMod(DbsBrly* dbsbrly, const ubigint jrefTrig);
