...
PnlBrlyConMNSegment::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYCONMNSEGMENTDATA) {
};
...
PnlBrlyConMNSegment::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYCONMNSEGMENTDO) {
	ixVDo = 0;
};
