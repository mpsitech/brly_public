/**
  ...
  * job handler for job QryBrlyConMapNode (declarations)
...
/**
  * QryBrlyConMapNode
  */
class QryBrlyConMapNode : public JobBrly {
...
public:
	QryBrlyConMapNode(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~QryBrlyConMapNode();
...
public:
	...
	BrlyQConMapNode* getRecByJnum(const uint jnum);
