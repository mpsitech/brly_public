/**
  ...
  * job handler for job PnlBrlyConMNSegment (declarations)
...
/**
  * PnlBrlyConMNSegment
  */
class PnlBrlyConMNSegment : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQConMNSegment* rst = NULL, QryBrlyConMNSegment::StatShr* statshrqry = NULL, QryBrlyConMNSegment::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyConMNSegment(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyConMNSegment();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyConMNSegment::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
