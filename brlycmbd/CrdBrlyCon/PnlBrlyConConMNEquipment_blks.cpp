...
PnlBrlyConConMNEquipment::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYCONCONMNEQUIPMENTDATA) {
};
...
PnlBrlyConConMNEquipment::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYCONCONMNEQUIPMENTDO) {
	ixVDo = 0;
};
