/**
  ...
  * job handler for job QryBrlyPty1NEquipment (declarations)
...
/**
  ...
  */
class QryBrlyPty1NEquipment : public JobBrly {
...
public:
	QryBrlyPty1NEquipment(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~QryBrlyPty1NEquipment();
...
public:
	...
	BrlyQPty1NEquipment* getRecByJnum(const uint jnum);
...
public:
	...
	bool handleCallBrlyEqpMod_ptyEq(DbsBrly* dbsbrly, const ubigint jrefTrig, const ubigint refInv);
};
