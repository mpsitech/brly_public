...
PnlBrlyPtyList::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYPTYLISTDATA) {
};
...
PnlBrlyPtyList::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYPTYLISTDO) {
	ixVDo = 0;
};
