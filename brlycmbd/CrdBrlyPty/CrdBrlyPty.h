...
public:
	...
	public:
		...
		static const uint MTXCRDPTY = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdPty = "");
...
public:
	CrdBrlyPty(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale, const ubigint ref = 0);
	~CrdBrlyPty();
