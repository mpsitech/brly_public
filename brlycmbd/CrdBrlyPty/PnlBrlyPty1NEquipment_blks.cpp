...
PnlBrlyPty1NEquipment::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYPTY1NEQUIPMENTDATA) {
};
...
PnlBrlyPty1NEquipment::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYPTY1NEQUIPMENTDO) {
	ixVDo = 0;
};
