/**
  ...
  * job handler for job PnlBrlyPtyHeadbar (declarations)
...
/**
  * PnlBrlyPtyHeadbar
  */
class PnlBrlyPtyHeadbar : public JobBrly {
...
public:
	PnlBrlyPtyHeadbar(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyPtyHeadbar();
