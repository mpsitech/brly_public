/**
  ...
  * job handler for job PnlBrlySegList (declarations)
...
/**
  * PnlBrlySegList
  */
class PnlBrlySegList : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQSegList* rst = NULL, QryBrlySegList::StatShr* statshrqry = NULL, QryBrlySegList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlySegList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlySegList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlySegList::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
