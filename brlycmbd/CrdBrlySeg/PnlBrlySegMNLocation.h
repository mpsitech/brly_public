...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQSegMNLocation* rst = NULL, QryBrlySegMNLocation::StatShr* statshrqry = NULL, QryBrlySegMNLocation::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlySegMNLocation(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlySegMNLocation();
