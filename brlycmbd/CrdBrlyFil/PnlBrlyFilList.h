/**
  ...
  * job handler for job PnlBrlyFilList (declarations)
...
/**
  * PnlBrlyFilList
  */
class PnlBrlyFilList : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQFilList* rst = NULL, QryBrlyFilList::StatShr* statshrqry = NULL, QryBrlyFilList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyFilList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyFilList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyFilList::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
