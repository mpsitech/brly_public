...
PnlBrlyFilDetail::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFILDETAILDATA) {
};
...
PnlBrlyFilDetail::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFILDETAILDO) {
	ixVDo = 0;
};
