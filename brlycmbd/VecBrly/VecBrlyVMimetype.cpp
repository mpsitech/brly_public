/**
  * \file VecBrlyVMimetype.cpp
  * vector VecBrlyVMimetype (implementation)
...
/******************************************************************************
 namespace VecBrlyVMimetype
 ******************************************************************************/

uint VecBrlyVMimetype::getIx(
			const string& sref
		) {
...
string VecBrlyVMimetype::getSref(
			const uint ix
		) {
...
string VecBrlyVMimetype::getTitle(
			const uint ix
		) {
