...
/**
	* StgBrlycmbd
	*/
class StgBrlycmbd : public Block {
...
public:
	StgBrlycmbd(const usmallint jobprcn = 1, const usmallint opprcn = 1, const usmallint appsrvport = 0, const bool https = false, const usmallint histlength = 20);
...
public:
	...
	set<uint> comm(const StgBrlycmbd* comp);
	set<uint> diff(const StgBrlycmbd* comp);
};
