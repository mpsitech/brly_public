...
void QryBrlyLocEnd1NLeg::rerun(
	...
	xchg->addRefClstn(VecBrlyVCall::CALLBRLYLEGMOD_ELOEQ, jref, Clstn::VecVJobmask::ALL, 0, preRefLoc, Clstn::VecVJactype::LOCK);
};
...
void QryBrlyLocEnd1NLeg::handleCall(
	...
	} else if (call->ixVCall == VecBrlyVCall::CALLBRLYLEGMOD_ELOEQ) {
		call->abort = handleCallBrlyLegMod_eloEq(dbsbrly, call->jref, call->argInv.ref);
	};
};

bool QryBrlyLocEnd1NLeg::handleCallBrlyStubChg(
			DbsBrly* dbsbrly
