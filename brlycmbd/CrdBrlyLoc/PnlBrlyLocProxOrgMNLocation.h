/**
  ...
  * job handler for job PnlBrlyLocProxOrgMNLocation (declarations)
...
/**
  ...
  */
class PnlBrlyLocProxOrgMNLocation : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLocProxOrgMNLocation* rst = NULL, QryBrlyLocProxOrgMNLocation::StatShr* statshrqry = NULL, QryBrlyLocProxOrgMNLocation::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyLocProxOrgMNLocation(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyLocProxOrgMNLocation();
...
public:
	...
	QryBrlyLocProxOrgMNLocation* qry;

	BrlyProxRMLocationMLocation recPlocRloc;
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyLocProxOrgMNLocation::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
