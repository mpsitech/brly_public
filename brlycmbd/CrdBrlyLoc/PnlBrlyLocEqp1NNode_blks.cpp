...
PnlBrlyLocEqp1NNode::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYLOCEQP1NNODEDATA) {
};
...
PnlBrlyLocEqp1NNode::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYLOCEQP1NNODEDO) {
	ixVDo = 0;
};
