...
public:
	QryBrlyLocMNFlight(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~QryBrlyLocMNFlight();
...
public:
	...
	BrlyQLocMNFlight* getRecByJnum(const uint jnum);
...
public:
	...
	bool handleCallBrlyFltRlocMod_locEq(DbsBrly* dbsbrly, const ubigint jrefTrig, const ubigint refInv);
};
