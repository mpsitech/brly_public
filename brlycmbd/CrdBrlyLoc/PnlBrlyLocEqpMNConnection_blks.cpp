...
PnlBrlyLocEqpMNConnection::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYLOCEQPMNCONNECTIONDATA) {
};
...
PnlBrlyLocEqpMNConnection::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYLOCEQPMNCONNECTIONDO) {
	ixVDo = 0;
};
