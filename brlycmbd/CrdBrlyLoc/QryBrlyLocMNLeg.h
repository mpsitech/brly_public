...
public:
	QryBrlyLocMNLeg(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~QryBrlyLocMNLeg();
...
public:
	...
	BrlyQLocMNLeg* getRecByJnum(const uint jnum);
...
public:
	...
	bool handleCallBrlyLegRlocMod_locEq(DbsBrly* dbsbrly, const ubigint jrefTrig, const ubigint refInv);
};
