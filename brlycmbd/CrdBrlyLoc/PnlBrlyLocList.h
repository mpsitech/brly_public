/**
  ...
  * job handler for job PnlBrlyLocList (declarations)
...
/**
  * PnlBrlyLocList
  */
class PnlBrlyLocList : public JobBrly {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListBrlyQLocList* rst = NULL, QryBrlyLocList::StatShr* statshrqry = NULL, QryBrlyLocList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
public:
	PnlBrlyLocList(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~PnlBrlyLocList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsBrly* dbsbrly, QryBrlyLocList::StgIac* _stgiacqry, DpchEngBrly** dpcheng);
