/**
  ...
  * job handler for job QryBrlyLocMapVisLocation (declarations)
...
/**
  ...
  */
class QryBrlyLocMapVisLocation : public JobBrly {
...
public:
	QryBrlyLocMapVisLocation(XchgBrly* xchg, DbsBrly* dbsbrly, const ubigint jrefSup, const uint ixBrlyVLocale);
	~QryBrlyLocMapVisLocation();
...
public:
	...
	BrlyQLocMapVisLocation* getRecByJnum(const uint jnum);
