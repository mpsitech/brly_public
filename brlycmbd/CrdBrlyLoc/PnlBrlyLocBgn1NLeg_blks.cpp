...
PnlBrlyLocBgn1NLeg::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYLOCBGN1NLEGDATA) {
};
...
PnlBrlyLocBgn1NLeg::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYLOCBGN1NLEGDO) {
	ixVDo = 0;
};
