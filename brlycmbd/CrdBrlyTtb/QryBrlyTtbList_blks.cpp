/**
  * \file QryBrlyTtbList_blks.cpp
  * job handler for job QryBrlyTtbList (implementation of blocks)
...
void QryBrlyTtbList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryBrlyTtbList::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryBrlyTtbList";
...
void QryBrlyTtbList::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryBrlyTtbList";
