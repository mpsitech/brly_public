...
PnlBrlyTtbList::DpchAppData::DpchAppData() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYTTBLISTDATA) {
};
...
PnlBrlyTtbList::DpchAppDo::DpchAppDo() : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYTTBLISTDO) {
	ixVDo = 0;
};
