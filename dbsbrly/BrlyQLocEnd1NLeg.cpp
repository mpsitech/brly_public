...
void TblBrlyQLocEnd1NLeg::insertRec(
			BrlyQLocEnd1NLeg* rec
		) {
};
...
MyTblBrlyQLocEnd1NLeg::MyTblBrlyQLocEnd1NLeg() : TblBrlyQLocEnd1NLeg(), MyTable() {
	stmtInsertRec = NULL;
	stmtUpdateRec = NULL;
...
bool MyTblBrlyQLocEnd1NLeg::loadRecBySQL(
	...
	if (!dbresult) throw DbsException("DbsException / MySQL: error storing result! (TblBrlyQLocEnd1NLeg / loadRecBySQL)\n");
...
ubigint MyTblBrlyQLocEnd1NLeg::loadRstBySQL(
	...
	dbresult = mysql_store_result(dbs);
	if (!dbresult) throw DbsException("DbsException / MySQL: error storing result! (TblBrlyQLocEnd1NLeg / loadRstBySQL)\n");
...
void MyTblBrlyQLocEnd1NLeg::insertRec(
			BrlyQLocEnd1NLeg* rec
		) {
	...
	if (mysql_stmt_bind_param(stmtInsertRec, bind)) throw DbsException("DbsException / MySQL: error binding to statement! (TblBrlyQLocEnd1NLeg / stmtInsertRec)\n");
	if (mysql_stmt_execute(stmtInsertRec)) throw DbsException("DbsException / MySQL: error executing statement! (TblBrlyQLocEnd1NLeg / stmtInsertRec)\n");
...
void MyTblBrlyQLocEnd1NLeg::updateRec(
	...
	if (mysql_stmt_bind_param(stmtUpdateRec, bind)) throw DbsException("DbsException / MySQL: error binding to statement! (TblBrlyQLocEnd1NLeg / stmtUpdateRec)\n");
	if (mysql_stmt_execute(stmtUpdateRec)) throw DbsException("DbsException / MySQL: error executing statement! (TblBrlyQLocEnd1NLeg / stmtUpdateRec)\n");
};
...
void MyTblBrlyQLocEnd1NLeg::removeRecByQref(
	...
	if (mysql_stmt_bind_param(stmtRemoveRecByQref, &bind)) throw DbsException("DbsException / MySQL: error binding to statement! (TblBrlyQLocEnd1NLeg / stmtRemoveRecByQref)\n");
	if (mysql_stmt_execute(stmtRemoveRecByQref)) throw DbsException("DbsException / MySQL: error executing statement! (TblBrlyQLocEnd1NLeg / stmtRemoveRecByQref)\n");
};
...
void MyTblBrlyQLocEnd1NLeg::removeRstByJref(
	...
	if (mysql_stmt_bind_param(stmtRemoveRstByJref, &bind)) throw DbsException("DbsException / MySQL: error binding to statement! (TblBrlyQLocEnd1NLeg / stmtRemoveRstByJref)\n");
	if (mysql_stmt_execute(stmtRemoveRstByJref)) throw DbsException("DbsException / MySQL: error executing statement! (TblBrlyQLocEnd1NLeg / stmtRemoveRstByJref)\n");
};
...
PgTblBrlyQLocEnd1NLeg::PgTblBrlyQLocEnd1NLeg() : TblBrlyQLocEnd1NLeg(), PgTable() {
};
...
void PgTblBrlyQLocEnd1NLeg::initStatements() {
	...
	res = PQprepare(dbs, "TblBrlyQLocEnd1NLeg_insertRec", "INSERT INTO TblBrlyQLocEnd1NLeg (jref, jnum, ref) VALUES ($1,$2,$3) RETURNING qref", 3, NULL);
	if (PQresultStatus(res) != PGRES_COMMAND_OK) initStatementsErr(res);
	res = PQprepare(dbs, "TblBrlyQLocEnd1NLeg_updateRec", "UPDATE TblBrlyQLocEnd1NLeg SET jref = $1, jnum = $2, ref = $3 WHERE qref = $4", 4, NULL);
	if (PQresultStatus(res) != PGRES_COMMAND_OK) initStatementsErr(res);
	res = PQprepare(dbs, "TblBrlyQLocEnd1NLeg_removeRecByQref", "DELETE FROM TblBrlyQLocEnd1NLeg WHERE qref = $1", 1, NULL);
	if (PQresultStatus(res) != PGRES_COMMAND_OK) initStatementsErr(res);
	res = PQprepare(dbs, "TblBrlyQLocEnd1NLeg_removeRstByJref", "DELETE FROM TblBrlyQLocEnd1NLeg WHERE jref = $1", 1, NULL);
	if (PQresultStatus(res) != PGRES_COMMAND_OK) initStatementsErr(res);

	res = PQprepare(dbs, "TblBrlyQLocEnd1NLeg_loadRecByQref", "SELECT qref, jref, jnum, ref FROM TblBrlyQLocEnd1NLeg WHERE qref = $1", 1, NULL);
	if (PQresultStatus(res) != PGRES_COMMAND_OK) initStatementsErr(res);
	res = PQprepare(dbs, "TblBrlyQLocEnd1NLeg_loadRstByJref", "SELECT qref, jref, jnum, ref FROM TblBrlyQLocEnd1NLeg WHERE jref = $1 ORDER BY jnum ASC", 1, NULL);
	if (PQresultStatus(res) != PGRES_COMMAND_OK) initStatementsErr(res);
};
...
bool PgTblBrlyQLocEnd1NLeg::loadRecByStmt(
	...
	if (PQresultStatus(res) != PGRES_TUPLES_OK) throw DbsException("DbsException / PgSQL: error executing statement! (TblBrlyQLocEnd1NLeg / " + srefStmt + ")\n");
...
void PgTblBrlyQLocEnd1NLeg::insertRec(
			BrlyQLocEnd1NLeg* rec
		) {
	PGresult* res;
	char* ptr;
	...
	if (PQresultStatus(res) != PGRES_TUPLES_OK) throw DbsException("DbsException / PgSQL: error executing statement! (TblBrlyQLocEnd1NLeg_insertRec)\n");
...
void PgTblBrlyQLocEnd1NLeg::updateRec(
	...
	if (PQresultStatus(res) != PGRES_COMMAND_OK) throw DbsException("DbsException / PgSQL: error executing statement! (TblBrlyQLocEnd1NLeg_updateRec)\n");
...
void PgTblBrlyQLocEnd1NLeg::removeRecByQref(
	...
	if (PQresultStatus(res) != PGRES_COMMAND_OK)
		throw DbsException("DbsException / PgSQL: error executing statement! (TblBrlyQLocEnd1NLeg_removeRecByQref)\n");
...
void PgTblBrlyQLocEnd1NLeg::removeRstByJref(
	...
	if (PQresultStatus(res) != PGRES_COMMAND_OK)
		throw DbsException("DbsException / PgSQL: error executing statement! (TblBrlyQLocEnd1NLeg_removeRstByJref)\n");
