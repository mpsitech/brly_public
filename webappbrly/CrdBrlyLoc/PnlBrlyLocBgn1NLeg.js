/**
  * \file PnlBrlyLocBgn1NLeg.js
  * web client functionality for panel PnlBrlyLocBgn1NLeg
...
function refreshBD(bNotD, chgcol) {
	...
	if (chgcol) {
		...
		for (i=0;i<doc.cols.length;i++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagBrlyLocBgn1NLeg", doc.cols[i]));
