/**
  ...
  * API code for job QryBrlyFltOrgMNFlight (implementation)
...
/******************************************************************************
 class QryBrlyFltOrgMNFlight::StatApp
 ******************************************************************************/

QryBrlyFltOrgMNFlight::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyFltOrgMNFlight::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyFltOrgMNFlight");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyFltOrgMNFlight";
...
set<uint> QryBrlyFltOrgMNFlight::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltOrgMNFlight::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyFltOrgMNFlight::StatShr
 ******************************************************************************/

QryBrlyFltOrgMNFlight::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyFltOrgMNFlight::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyFltOrgMNFlight");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyFltOrgMNFlight";
...
set<uint> QryBrlyFltOrgMNFlight::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltOrgMNFlight::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyFltOrgMNFlight::StgIac
 ******************************************************************************/

QryBrlyFltOrgMNFlight::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyFltOrgMNFlight::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyFltOrgMNFlight");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyFltOrgMNFlight";
...
void QryBrlyFltOrgMNFlight::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyFltOrgMNFlight";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyFltOrgMNFlight";
...
set<uint> QryBrlyFltOrgMNFlight::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltOrgMNFlight::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
