/**
  * \file PnlBrlyRegHeadbar.cpp
  * API code for job PnlBrlyRegHeadbar (implementation)
...
/******************************************************************************
 class PnlBrlyRegHeadbar::StgInf
 ******************************************************************************/

PnlBrlyRegHeadbar::StgInf::StgInf(
...
bool PnlBrlyRegHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfBrlyRegHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfBrlyRegHeadbar";
...
set<uint> PnlBrlyRegHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyRegHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyRegHeadbar::Tag
 ******************************************************************************/

PnlBrlyRegHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlBrlyRegHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlyRegHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlyRegHeadbar";
...
/******************************************************************************
 class PnlBrlyRegHeadbar::DpchEngData
 ******************************************************************************/

PnlBrlyRegHeadbar::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYREGHEADBARDATA) {
};

string PnlBrlyRegHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyRegHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlyRegHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
