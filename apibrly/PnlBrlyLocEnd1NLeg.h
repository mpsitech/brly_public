/**
  ...
  * API code for job PnlBrlyLocEnd1NLeg (declarations)
...
namespace PnlBrlyLocEnd1NLeg {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryBrlyLocEnd1NLeg::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryBrlyLocEnd1NLeg::StatApp statappqry;
