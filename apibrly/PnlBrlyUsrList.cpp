/**
  ...
  * API code for job PnlBrlyUsrList (implementation)
...
/******************************************************************************
 class PnlBrlyUsrList::VecVDo
 ******************************************************************************/

uint PnlBrlyUsrList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlBrlyUsrList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlBrlyUsrList::ContIac
 ******************************************************************************/

PnlBrlyUsrList::ContIac::ContIac(
			const uint numFTos
		) : Block() {
...
bool PnlBrlyUsrList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacBrlyUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacBrlyUsrList";
...
void PnlBrlyUsrList::ContIac::writeXML(
	...
	else itemtag = "ContitemIacBrlyUsrList";
...
set<uint> PnlBrlyUsrList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyUsrList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyUsrList::ContInf
 ******************************************************************************/

PnlBrlyUsrList::ContInf::ContInf(
...
bool PnlBrlyUsrList::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfBrlyUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfBrlyUsrList";
...
set<uint> PnlBrlyUsrList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyUsrList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyUsrList::StatShr
 ******************************************************************************/

PnlBrlyUsrList::StatShr::StatShr(
...
bool PnlBrlyUsrList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrBrlyUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrBrlyUsrList";
...
set<uint> PnlBrlyUsrList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyUsrList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyUsrList::StgIac
 ******************************************************************************/

PnlBrlyUsrList::StgIac::StgIac(
...
bool PnlBrlyUsrList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacBrlyUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacBrlyUsrList";
...
void PnlBrlyUsrList::StgIac::writeXML(
	...
	else itemtag = "StgitemIacBrlyUsrList";
...
set<uint> PnlBrlyUsrList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyUsrList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlBrlyUsrList::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlyUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlyUsrList";
...
/******************************************************************************
 class PnlBrlyUsrList::DpchAppData
 ******************************************************************************/

PnlBrlyUsrList::DpchAppData::DpchAppData(
			const string& scrJref
			, ContIac* contiac
			, StgIac* stgiac
			, QryBrlyUsrList::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYUSRLISTDATA, scrJref) {
...
string PnlBrlyUsrList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyUsrList::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlyUsrListData");
...
/******************************************************************************
 class PnlBrlyUsrList::DpchAppDo
 ******************************************************************************/

PnlBrlyUsrList::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYUSRLISTDO, scrJref) {
...
string PnlBrlyUsrList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyUsrList::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlyUsrListDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/brly");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
/******************************************************************************
 class PnlBrlyUsrList::DpchEngData
 ******************************************************************************/

PnlBrlyUsrList::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYUSRLISTDATA) {
	feedFCsiQst.tag = "FeedFCsiQst";
	feedFTos.tag = "FeedFTos";
};

string PnlBrlyUsrList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyUsrList::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlyUsrListData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryBrlyUsrList::StatApp();
		statshrqry = QryBrlyUsrList::StatShr();
