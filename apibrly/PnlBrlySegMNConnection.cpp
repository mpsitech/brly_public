/**
  * \file PnlBrlySegMNConnection.cpp
  * API code for job PnlBrlySegMNConnection (implementation)
...
/******************************************************************************
 class PnlBrlySegMNConnection::VecVDo
 ******************************************************************************/

uint PnlBrlySegMNConnection::VecVDo::getIx(
			const string& sref
		) {
...
string PnlBrlySegMNConnection::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlBrlySegMNConnection::ContInf
 ******************************************************************************/

PnlBrlySegMNConnection::ContInf::ContInf(
...
bool PnlBrlySegMNConnection::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfBrlySegMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfBrlySegMNConnection";
...
set<uint> PnlBrlySegMNConnection::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlySegMNConnection::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlySegMNConnection::StatApp
 ******************************************************************************/

PnlBrlySegMNConnection::StatApp::StatApp(
...
bool PnlBrlySegMNConnection::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppBrlySegMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppBrlySegMNConnection";
...
set<uint> PnlBrlySegMNConnection::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlySegMNConnection::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlySegMNConnection::StatShr
 ******************************************************************************/

PnlBrlySegMNConnection::StatShr::StatShr(
...
bool PnlBrlySegMNConnection::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrBrlySegMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrBrlySegMNConnection";
...
set<uint> PnlBrlySegMNConnection::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlySegMNConnection::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlySegMNConnection::StgIac
 ******************************************************************************/

PnlBrlySegMNConnection::StgIac::StgIac(
...
bool PnlBrlySegMNConnection::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacBrlySegMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacBrlySegMNConnection";
...
void PnlBrlySegMNConnection::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacBrlySegMNConnection";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacBrlySegMNConnection";
...
set<uint> PnlBrlySegMNConnection::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlySegMNConnection::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlySegMNConnection::Tag
 ******************************************************************************/

PnlBrlySegMNConnection::Tag::Tag(
			const string& Cpt
			, const string& Trs
...
bool PnlBrlySegMNConnection::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlySegMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlySegMNConnection";
...
/******************************************************************************
 class PnlBrlySegMNConnection::DpchAppData
 ******************************************************************************/

PnlBrlySegMNConnection::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryBrlySegMNConnection::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYSEGMNCONNECTIONDATA, scrJref) {
...
string PnlBrlySegMNConnection::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlySegMNConnection::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlySegMNConnectionData");
...
/******************************************************************************
 class PnlBrlySegMNConnection::DpchAppDo
 ******************************************************************************/

PnlBrlySegMNConnection::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYSEGMNCONNECTIONDO, scrJref) {
...
string PnlBrlySegMNConnection::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlySegMNConnection::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlySegMNConnectionDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/brly");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
/******************************************************************************
 class PnlBrlySegMNConnection::DpchEngData
 ******************************************************************************/

PnlBrlySegMNConnection::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYSEGMNCONNECTIONDATA) {
	feedFCsiQst.tag = "FeedFCsiQst";
};

string PnlBrlySegMNConnection::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlySegMNConnection::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlySegMNConnectionData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryBrlySegMNConnection::StatApp();
		statshrqry = QryBrlySegMNConnection::StatShr();
		stgiacqry = QryBrlySegMNConnection::StgIac();
	};
};
