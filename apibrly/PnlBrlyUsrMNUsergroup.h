/**
  ...
  * API code for job PnlBrlyUsrMNUsergroup (declarations)
...
/**
  ...
  */
namespace PnlBrlyUsrMNUsergroup {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryBrlyUsrMNUsergroup::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryBrlyUsrMNUsergroup::StatApp statappqry;
