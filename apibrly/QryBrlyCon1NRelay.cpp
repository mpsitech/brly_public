/**
  ...
  * API code for job QryBrlyCon1NRelay (implementation)
...
/******************************************************************************
 class QryBrlyCon1NRelay::StatApp
 ******************************************************************************/

QryBrlyCon1NRelay::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyCon1NRelay::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyCon1NRelay");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyCon1NRelay";
...
set<uint> QryBrlyCon1NRelay::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyCon1NRelay::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyCon1NRelay::StatShr
 ******************************************************************************/

QryBrlyCon1NRelay::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyCon1NRelay::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyCon1NRelay");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyCon1NRelay";
...
set<uint> QryBrlyCon1NRelay::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyCon1NRelay::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyCon1NRelay::StgIac
 ******************************************************************************/

QryBrlyCon1NRelay::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyCon1NRelay::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyCon1NRelay");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyCon1NRelay";
...
void QryBrlyCon1NRelay::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyCon1NRelay";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyCon1NRelay";
...
set<uint> QryBrlyCon1NRelay::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyCon1NRelay::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
