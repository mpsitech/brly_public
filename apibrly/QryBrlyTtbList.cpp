/**
  ...
  * API code for job QryBrlyTtbList (implementation)
...
/******************************************************************************
 class QryBrlyTtbList::VecVOrd
 ******************************************************************************/

uint QryBrlyTtbList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryBrlyTtbList::VecVOrd::getSref(
			const uint ix
		) {
...
QryBrlyTtbList::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyTtbList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyTtbList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyTtbList";
...
set<uint> QryBrlyTtbList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyTtbList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyTtbList::StatShr
 ******************************************************************************/

QryBrlyTtbList::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyTtbList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyTtbList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyTtbList";
...
set<uint> QryBrlyTtbList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyTtbList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyTtbList::StgIac
 ******************************************************************************/

QryBrlyTtbList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyTtbList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyTtbList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyTtbList";
...
void QryBrlyTtbList::StgIac::writeXML(
	...
	else itemtag = "StgitemIacQryBrlyTtbList";
...
set<uint> QryBrlyTtbList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyTtbList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
