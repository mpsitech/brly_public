/**
  ...
  * API code for job QryBrlyLocMNSegment (implementation)
...
/******************************************************************************
 class QryBrlyLocMNSegment::StatApp
 ******************************************************************************/

QryBrlyLocMNSegment::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyLocMNSegment::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyLocMNSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyLocMNSegment";
...
set<uint> QryBrlyLocMNSegment::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocMNSegment::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLocMNSegment::StatShr
 ******************************************************************************/

QryBrlyLocMNSegment::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyLocMNSegment::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyLocMNSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyLocMNSegment";
...
set<uint> QryBrlyLocMNSegment::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocMNSegment::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLocMNSegment::StgIac
 ******************************************************************************/

QryBrlyLocMNSegment::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyLocMNSegment::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyLocMNSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyLocMNSegment";
...
void QryBrlyLocMNSegment::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyLocMNSegment";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyLocMNSegment";
...
set<uint> QryBrlyLocMNSegment::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocMNSegment::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
