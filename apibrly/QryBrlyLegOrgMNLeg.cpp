/**
  ...
  * API code for job QryBrlyLegOrgMNLeg (implementation)
...
/******************************************************************************
 class QryBrlyLegOrgMNLeg::StatApp
 ******************************************************************************/

QryBrlyLegOrgMNLeg::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyLegOrgMNLeg::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyLegOrgMNLeg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyLegOrgMNLeg";
...
set<uint> QryBrlyLegOrgMNLeg::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLegOrgMNLeg::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLegOrgMNLeg::StatShr
 ******************************************************************************/

QryBrlyLegOrgMNLeg::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyLegOrgMNLeg::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyLegOrgMNLeg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyLegOrgMNLeg";
...
set<uint> QryBrlyLegOrgMNLeg::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLegOrgMNLeg::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLegOrgMNLeg::StgIac
 ******************************************************************************/

QryBrlyLegOrgMNLeg::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyLegOrgMNLeg::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyLegOrgMNLeg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyLegOrgMNLeg";
...
void QryBrlyLegOrgMNLeg::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyLegOrgMNLeg";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyLegOrgMNLeg";
...
set<uint> QryBrlyLegOrgMNLeg::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLegOrgMNLeg::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
