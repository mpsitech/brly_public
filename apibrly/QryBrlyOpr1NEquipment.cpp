/**
  ...
  * API code for job QryBrlyOpr1NEquipment (implementation)
...
/******************************************************************************
 class QryBrlyOpr1NEquipment::StatApp
 ******************************************************************************/

QryBrlyOpr1NEquipment::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyOpr1NEquipment::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyOpr1NEquipment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyOpr1NEquipment";
...
set<uint> QryBrlyOpr1NEquipment::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyOpr1NEquipment::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyOpr1NEquipment::StatShr
 ******************************************************************************/

QryBrlyOpr1NEquipment::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyOpr1NEquipment::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyOpr1NEquipment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyOpr1NEquipment";
...
set<uint> QryBrlyOpr1NEquipment::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyOpr1NEquipment::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyOpr1NEquipment::StgIac
 ******************************************************************************/

QryBrlyOpr1NEquipment::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyOpr1NEquipment::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyOpr1NEquipment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyOpr1NEquipment";
...
void QryBrlyOpr1NEquipment::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyOpr1NEquipment";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyOpr1NEquipment";
...
set<uint> QryBrlyOpr1NEquipment::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyOpr1NEquipment::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
