/**
  * \file PnlBrlyFltMNConnection.cpp
  * API code for job PnlBrlyFltMNConnection (implementation)
...
/******************************************************************************
 class PnlBrlyFltMNConnection::VecVDo
 ******************************************************************************/

uint PnlBrlyFltMNConnection::VecVDo::getIx(
			const string& sref
		) {
...
string PnlBrlyFltMNConnection::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlBrlyFltMNConnection::ContInf
 ******************************************************************************/

PnlBrlyFltMNConnection::ContInf::ContInf(
...
bool PnlBrlyFltMNConnection::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfBrlyFltMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfBrlyFltMNConnection";
...
set<uint> PnlBrlyFltMNConnection::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyFltMNConnection::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyFltMNConnection::StatApp
 ******************************************************************************/

PnlBrlyFltMNConnection::StatApp::StatApp(
...
bool PnlBrlyFltMNConnection::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppBrlyFltMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppBrlyFltMNConnection";
...
set<uint> PnlBrlyFltMNConnection::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyFltMNConnection::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyFltMNConnection::StatShr
 ******************************************************************************/

PnlBrlyFltMNConnection::StatShr::StatShr(
...
bool PnlBrlyFltMNConnection::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrBrlyFltMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrBrlyFltMNConnection";
...
set<uint> PnlBrlyFltMNConnection::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyFltMNConnection::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyFltMNConnection::StgIac
 ******************************************************************************/

PnlBrlyFltMNConnection::StgIac::StgIac(
...
bool PnlBrlyFltMNConnection::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacBrlyFltMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacBrlyFltMNConnection";
...
void PnlBrlyFltMNConnection::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacBrlyFltMNConnection";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacBrlyFltMNConnection";
...
set<uint> PnlBrlyFltMNConnection::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyFltMNConnection::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyFltMNConnection::Tag
 ******************************************************************************/

PnlBrlyFltMNConnection::Tag::Tag(
			const string& Cpt
			, const string& Trs
...
bool PnlBrlyFltMNConnection::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlyFltMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlyFltMNConnection";
...
/******************************************************************************
 class PnlBrlyFltMNConnection::DpchAppData
 ******************************************************************************/

PnlBrlyFltMNConnection::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryBrlyFltMNConnection::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFLTMNCONNECTIONDATA, scrJref) {
...
string PnlBrlyFltMNConnection::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyFltMNConnection::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlyFltMNConnectionData");
...
/******************************************************************************
 class PnlBrlyFltMNConnection::DpchAppDo
 ******************************************************************************/

PnlBrlyFltMNConnection::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFLTMNCONNECTIONDO, scrJref) {
...
string PnlBrlyFltMNConnection::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyFltMNConnection::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlyFltMNConnectionDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/brly");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
/******************************************************************************
 class PnlBrlyFltMNConnection::DpchEngData
 ******************************************************************************/

PnlBrlyFltMNConnection::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYFLTMNCONNECTIONDATA) {
	feedFCsiQst.tag = "FeedFCsiQst";
};

string PnlBrlyFltMNConnection::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyFltMNConnection::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlyFltMNConnectionData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryBrlyFltMNConnection::StatApp();
		statshrqry = QryBrlyFltMNConnection::StatShr();
		stgiacqry = QryBrlyFltMNConnection::StgIac();
	};
};
