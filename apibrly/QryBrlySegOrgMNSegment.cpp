/**
  ...
  * API code for job QryBrlySegOrgMNSegment (implementation)
...
/******************************************************************************
 class QryBrlySegOrgMNSegment::StatApp
 ******************************************************************************/

QryBrlySegOrgMNSegment::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlySegOrgMNSegment::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlySegOrgMNSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlySegOrgMNSegment";
...
set<uint> QryBrlySegOrgMNSegment::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlySegOrgMNSegment::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlySegOrgMNSegment::StatShr
 ******************************************************************************/

QryBrlySegOrgMNSegment::StatShr::StatShr(
			const uint ntot
...
bool QryBrlySegOrgMNSegment::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlySegOrgMNSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlySegOrgMNSegment";
...
set<uint> QryBrlySegOrgMNSegment::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlySegOrgMNSegment::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlySegOrgMNSegment::StgIac
 ******************************************************************************/

QryBrlySegOrgMNSegment::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlySegOrgMNSegment::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlySegOrgMNSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlySegOrgMNSegment";
...
void QryBrlySegOrgMNSegment::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlySegOrgMNSegment";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlySegOrgMNSegment";
...
set<uint> QryBrlySegOrgMNSegment::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlySegOrgMNSegment::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
