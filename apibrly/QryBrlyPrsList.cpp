/**
  ...
  * API code for job QryBrlyPrsList (implementation)
...
/******************************************************************************
 class QryBrlyPrsList::VecVOrd
 ******************************************************************************/

uint QryBrlyPrsList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryBrlyPrsList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryBrlyPrsList::StatApp
 ******************************************************************************/

QryBrlyPrsList::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyPrsList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyPrsList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyPrsList";
...
set<uint> QryBrlyPrsList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyPrsList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyPrsList::StatShr
 ******************************************************************************/

QryBrlyPrsList::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyPrsList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyPrsList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyPrsList";
...
set<uint> QryBrlyPrsList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyPrsList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyPrsList::StgIac
 ******************************************************************************/

QryBrlyPrsList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyPrsList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyPrsList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyPrsList";
...
void QryBrlyPrsList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyPrsList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyPrsList";
...
set<uint> QryBrlyPrsList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyPrsList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
