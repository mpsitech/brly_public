/**
  ...
  * API code for job QryBrlyLocBgn1NLeg (implementation)
...
/******************************************************************************
 class QryBrlyLocBgn1NLeg::StatApp
 ******************************************************************************/

QryBrlyLocBgn1NLeg::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyLocBgn1NLeg::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyLocBgn1NLeg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyLocBgn1NLeg";
...
set<uint> QryBrlyLocBgn1NLeg::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocBgn1NLeg::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLocBgn1NLeg::StatShr
 ******************************************************************************/

QryBrlyLocBgn1NLeg::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyLocBgn1NLeg::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyLocBgn1NLeg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyLocBgn1NLeg";
...
set<uint> QryBrlyLocBgn1NLeg::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocBgn1NLeg::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLocBgn1NLeg::StgIac
 ******************************************************************************/

QryBrlyLocBgn1NLeg::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyLocBgn1NLeg::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyLocBgn1NLeg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyLocBgn1NLeg";
...
void QryBrlyLocBgn1NLeg::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyLocBgn1NLeg";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyLocBgn1NLeg";
...
set<uint> QryBrlyLocBgn1NLeg::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocBgn1NLeg::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
