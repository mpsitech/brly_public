/**
  ...
  * API code for job PnlBrlyConRef1NSegment (declarations)
...
/**
  ...
  */
namespace PnlBrlyConRef1NSegment {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryBrlyConRef1NSegment::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryBrlyConRef1NSegment::StatApp statappqry;
