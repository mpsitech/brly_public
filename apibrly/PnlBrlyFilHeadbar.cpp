/**
  * \file PnlBrlyFilHeadbar.cpp
  * API code for job PnlBrlyFilHeadbar (implementation)
...
/******************************************************************************
 class PnlBrlyFilHeadbar::StgInf
 ******************************************************************************/

PnlBrlyFilHeadbar::StgInf::StgInf(
...
bool PnlBrlyFilHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfBrlyFilHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfBrlyFilHeadbar";
...
set<uint> PnlBrlyFilHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyFilHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyFilHeadbar::Tag
 ******************************************************************************/

PnlBrlyFilHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlBrlyFilHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlyFilHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlyFilHeadbar";
...
/******************************************************************************
 class PnlBrlyFilHeadbar::DpchEngData
 ******************************************************************************/

PnlBrlyFilHeadbar::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYFILHEADBARDATA) {
};

string PnlBrlyFilHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyFilHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlyFilHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
