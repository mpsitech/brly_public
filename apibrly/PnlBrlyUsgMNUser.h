/**
  ...
  * API code for job PnlBrlyUsgMNUser (declarations)
...
namespace PnlBrlyUsgMNUser {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryBrlyUsgMNUser::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryBrlyUsgMNUser::StatApp statappqry;
