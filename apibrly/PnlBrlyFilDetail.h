/**
  ...
  * API code for job PnlBrlyFilDetail (declarations)
...
namespace PnlBrlyFilDetail {
	...
	public:
		StatApp(const uint ixBrlyVExpstate = VecBrlyVExpstate::MIND, const bool LstCluAlt = true, const bool PupCntAlt = false, const bool PupMimAlt = false, const uint LstCluNumFirstdisp = 1);
