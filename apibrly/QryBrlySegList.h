/**
  ...
  * API code for job QryBrlySegList (declarations)
...
namespace QryBrlySegList {
	...
	public:
		StatApp(const uint firstcol = 1, const uint jnumFirstdisp = 1, const uint ncol = 11, const uint ndisp = 25);
