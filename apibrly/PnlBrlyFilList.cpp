/**
  ...
  * API code for job PnlBrlyFilList (implementation)
...
/******************************************************************************
 class PnlBrlyFilList::VecVDo
 ******************************************************************************/

uint PnlBrlyFilList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlBrlyFilList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlBrlyFilList::ContIac
 ******************************************************************************/

PnlBrlyFilList::ContIac::ContIac(
			const uint numFTos
		) : Block() {
...
bool PnlBrlyFilList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacBrlyFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacBrlyFilList";
...
void PnlBrlyFilList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "ContIacBrlyFilList";

	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemIacBrlyFilList";
...
set<uint> PnlBrlyFilList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyFilList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyFilList::ContInf
 ******************************************************************************/

PnlBrlyFilList::ContInf::ContInf(
...
bool PnlBrlyFilList::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfBrlyFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfBrlyFilList";
...
set<uint> PnlBrlyFilList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyFilList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyFilList::StatShr
 ******************************************************************************/

PnlBrlyFilList::StatShr::StatShr(
...
bool PnlBrlyFilList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrBrlyFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrBrlyFilList";
...
set<uint> PnlBrlyFilList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyFilList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyFilList::StgIac
 ******************************************************************************/

PnlBrlyFilList::StgIac::StgIac(
...
bool PnlBrlyFilList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacBrlyFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacBrlyFilList";
...
void PnlBrlyFilList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacBrlyFilList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacBrlyFilList";
...
set<uint> PnlBrlyFilList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyFilList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyFilList::Tag
 ******************************************************************************/

PnlBrlyFilList::Tag::Tag(
			const string& Cpt
			, const string& Trs
...
bool PnlBrlyFilList::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlyFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlyFilList";
...
/******************************************************************************
 class PnlBrlyFilList::DpchAppData
 ******************************************************************************/

PnlBrlyFilList::DpchAppData::DpchAppData(
			const string& scrJref
			, ContIac* contiac
			, StgIac* stgiac
			, QryBrlyFilList::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFILLISTDATA, scrJref) {
...
string PnlBrlyFilList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyFilList::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlyFilListData");
...
/******************************************************************************
 class PnlBrlyFilList::DpchAppDo
 ******************************************************************************/

PnlBrlyFilList::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFILLISTDO, scrJref) {
...
string PnlBrlyFilList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyFilList::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlyFilListDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/brly");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
/******************************************************************************
 class PnlBrlyFilList::DpchEngData
 ******************************************************************************/

PnlBrlyFilList::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYFILLISTDATA) {
	feedFCsiQst.tag = "FeedFCsiQst";
	feedFTos.tag = "FeedFTos";
};

string PnlBrlyFilList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyFilList::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlyFilListData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryBrlyFilList::StatApp();
		statshrqry = QryBrlyFilList::StatShr();
		stgiacqry = QryBrlyFilList::StgIac();
	};
};
