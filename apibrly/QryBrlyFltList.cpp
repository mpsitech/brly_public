/**
  ...
  * API code for job QryBrlyFltList (implementation)
...
/******************************************************************************
 class QryBrlyFltList::VecVOrd
 ******************************************************************************/

uint QryBrlyFltList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryBrlyFltList::VecVOrd::getSref(
			const uint ix
		) {
	if (ix == SRF) return("srf");
	else if (ix == EQP) return("eqp");
	else if (ix == LEG) return("leg");
...
QryBrlyFltList::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyFltList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyFltList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyFltList";
...
set<uint> QryBrlyFltList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyFltList::StatShr
 ******************************************************************************/

QryBrlyFltList::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyFltList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyFltList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyFltList";
...
set<uint> QryBrlyFltList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyFltList::StgIac
 ******************************************************************************/

QryBrlyFltList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyFltList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyFltList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyFltList";
...
void QryBrlyFltList::StgIac::writeXML(
	...
	else itemtag = "StgitemIacQryBrlyFltList";
...
set<uint> QryBrlyFltList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
