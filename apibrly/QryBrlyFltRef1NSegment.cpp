/**
  ...
  * API code for job QryBrlyFltRef1NSegment (implementation)
...
/******************************************************************************
 class QryBrlyFltRef1NSegment::StatApp
 ******************************************************************************/

QryBrlyFltRef1NSegment::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyFltRef1NSegment::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyFltRef1NSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyFltRef1NSegment";
...
set<uint> QryBrlyFltRef1NSegment::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltRef1NSegment::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyFltRef1NSegment::StatShr
 ******************************************************************************/

QryBrlyFltRef1NSegment::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyFltRef1NSegment::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyFltRef1NSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyFltRef1NSegment";
...
set<uint> QryBrlyFltRef1NSegment::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltRef1NSegment::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyFltRef1NSegment::StgIac
 ******************************************************************************/

QryBrlyFltRef1NSegment::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyFltRef1NSegment::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyFltRef1NSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyFltRef1NSegment";
...
void QryBrlyFltRef1NSegment::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyFltRef1NSegment";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyFltRef1NSegment";
...
set<uint> QryBrlyFltRef1NSegment::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltRef1NSegment::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
