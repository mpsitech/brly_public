/**
  * \file CrdBrlyFil.cpp
  * API code for job CrdBrlyFil (implementation)
...
/******************************************************************************
 class CrdBrlyFil::VecVDo
 ******************************************************************************/

uint CrdBrlyFil::VecVDo::getIx(
			const string& sref
		) {
...
string CrdBrlyFil::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdBrlyFil::VecVSge
 ******************************************************************************/

uint CrdBrlyFil::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdBrlyFil::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdBrlyFil::ContInf
 ******************************************************************************/

CrdBrlyFil::ContInf::ContInf(
			const uint numFSge
...
bool CrdBrlyFil::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfBrlyFil");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfBrlyFil";
...
set<uint> CrdBrlyFil::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> CrdBrlyFil::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdBrlyFil::StatApp
 ******************************************************************************/

CrdBrlyFil::StatApp::StatApp(
...
bool CrdBrlyFil::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppBrlyFil");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppBrlyFil";
...
set<uint> CrdBrlyFil::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdBrlyFil::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdBrlyFil::StatShr
 ******************************************************************************/

CrdBrlyFil::StatShr::StatShr(
...
bool CrdBrlyFil::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrBrlyFil");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrBrlyFil";
...
set<uint> CrdBrlyFil::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdBrlyFil::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdBrlyFil::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlyFil");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlyFil";
...
/******************************************************************************
 class CrdBrlyFil::DpchAppDo
 ******************************************************************************/

CrdBrlyFil::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYFILDO, scrJref) {
...
string CrdBrlyFil::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdBrlyFil::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlyFilDo");
...
/******************************************************************************
 class CrdBrlyFil::DpchEngData
 ******************************************************************************/

CrdBrlyFil::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYFILDATA) {
	feedFSge.tag = "FeedFSge";
};

string CrdBrlyFil::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdBrlyFil::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlyFilData");
	else
		basefound = checkXPath(docctx, basexpath);
