/**
  * \file CrdBrlyLoc.cpp
  * API code for job CrdBrlyLoc (implementation)
...
/******************************************************************************
 class CrdBrlyLoc::VecVDo
 ******************************************************************************/

uint CrdBrlyLoc::VecVDo::getIx(
			const string& sref
		) {
...
string CrdBrlyLoc::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdBrlyLoc::VecVSge
 ******************************************************************************/

uint CrdBrlyLoc::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdBrlyLoc::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdBrlyLoc::ContInf
 ******************************************************************************/

CrdBrlyLoc::ContInf::ContInf(
			const uint numFSge
...
bool CrdBrlyLoc::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfBrlyLoc");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfBrlyLoc";
...
set<uint> CrdBrlyLoc::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
	...
	if (MtxCrdLoc.compare(comp->MtxCrdLoc) == 0) insert(items, MTXCRDLOC);

	return(items);
};

set<uint> CrdBrlyLoc::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdBrlyLoc::StatApp
 ******************************************************************************/

CrdBrlyLoc::StatApp::StatApp(
...
bool CrdBrlyLoc::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppBrlyLoc");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppBrlyLoc";
...
set<uint> CrdBrlyLoc::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdBrlyLoc::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdBrlyLoc::StatShr
 ******************************************************************************/

CrdBrlyLoc::StatShr::StatShr(
...
bool CrdBrlyLoc::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrBrlyLoc");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrBrlyLoc";
...
set<uint> CrdBrlyLoc::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdBrlyLoc::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdBrlyLoc::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlyLoc");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlyLoc";
...
/******************************************************************************
 class CrdBrlyLoc::DpchAppDo
 ******************************************************************************/

CrdBrlyLoc::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppBrly(VecBrlyVDpch::DPCHAPPBRLYLOCDO, scrJref) {
...
string CrdBrlyLoc::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdBrlyLoc::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppBrlyLocDo");
...
/******************************************************************************
 class CrdBrlyLoc::DpchEngData
 ******************************************************************************/

CrdBrlyLoc::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYLOCDATA) {
	feedFSge.tag = "FeedFSge";
};

string CrdBrlyLoc::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdBrlyLoc::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlyLocData");
	else
		basefound = checkXPath(docctx, basexpath);
