/**
  ...
  * API code for job QryBrlyLocEnd1NLeg (implementation)
...
/******************************************************************************
 class QryBrlyLocEnd1NLeg::StatApp
 ******************************************************************************/

QryBrlyLocEnd1NLeg::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyLocEnd1NLeg::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyLocEnd1NLeg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyLocEnd1NLeg";
...
set<uint> QryBrlyLocEnd1NLeg::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocEnd1NLeg::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLocEnd1NLeg::StatShr
 ******************************************************************************/

QryBrlyLocEnd1NLeg::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyLocEnd1NLeg::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyLocEnd1NLeg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyLocEnd1NLeg";
...
set<uint> QryBrlyLocEnd1NLeg::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocEnd1NLeg::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLocEnd1NLeg::StgIac
 ******************************************************************************/

QryBrlyLocEnd1NLeg::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyLocEnd1NLeg::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyLocEnd1NLeg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyLocEnd1NLeg";
...
void QryBrlyLocEnd1NLeg::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyLocEnd1NLeg";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyLocEnd1NLeg";
...
set<uint> QryBrlyLocEnd1NLeg::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocEnd1NLeg::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
