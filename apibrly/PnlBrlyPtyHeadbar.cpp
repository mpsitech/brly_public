/**
  ...
  * API code for job PnlBrlyPtyHeadbar (implementation)
...
/******************************************************************************
 class PnlBrlyPtyHeadbar::StgInf
 ******************************************************************************/

PnlBrlyPtyHeadbar::StgInf::StgInf(
...
bool PnlBrlyPtyHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfBrlyPtyHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfBrlyPtyHeadbar";
...
set<uint> PnlBrlyPtyHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyPtyHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyPtyHeadbar::Tag
 ******************************************************************************/

PnlBrlyPtyHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlBrlyPtyHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlyPtyHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlyPtyHeadbar";
...
/******************************************************************************
 class PnlBrlyPtyHeadbar::DpchEngData
 ******************************************************************************/

PnlBrlyPtyHeadbar::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYPTYHEADBARDATA) {
};

string PnlBrlyPtyHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyPtyHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlyPtyHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
