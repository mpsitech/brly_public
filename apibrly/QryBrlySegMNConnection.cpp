/**
  ...
  * API code for job QryBrlySegMNConnection (implementation)
...
/******************************************************************************
 class QryBrlySegMNConnection::StatApp
 ******************************************************************************/

QryBrlySegMNConnection::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlySegMNConnection::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlySegMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlySegMNConnection";
...
set<uint> QryBrlySegMNConnection::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlySegMNConnection::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlySegMNConnection::StatShr
 ******************************************************************************/

QryBrlySegMNConnection::StatShr::StatShr(
			const uint ntot
...
bool QryBrlySegMNConnection::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlySegMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlySegMNConnection";
...
set<uint> QryBrlySegMNConnection::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlySegMNConnection::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlySegMNConnection::StgIac
 ******************************************************************************/

QryBrlySegMNConnection::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlySegMNConnection::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlySegMNConnection");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlySegMNConnection";
...
void QryBrlySegMNConnection::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlySegMNConnection";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlySegMNConnection";
...
set<uint> QryBrlySegMNConnection::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlySegMNConnection::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
