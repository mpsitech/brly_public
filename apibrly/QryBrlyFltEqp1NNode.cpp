/**
  ...
  * API code for job QryBrlyFltEqp1NNode (implementation)
...
QryBrlyFltEqp1NNode::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyFltEqp1NNode::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyFltEqp1NNode");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyFltEqp1NNode";
...
set<uint> QryBrlyFltEqp1NNode::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltEqp1NNode::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyFltEqp1NNode::StatShr
 ******************************************************************************/

QryBrlyFltEqp1NNode::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyFltEqp1NNode::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyFltEqp1NNode");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyFltEqp1NNode";
...
set<uint> QryBrlyFltEqp1NNode::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltEqp1NNode::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyFltEqp1NNode::StgIac
 ******************************************************************************/

QryBrlyFltEqp1NNode::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyFltEqp1NNode::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyFltEqp1NNode");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyFltEqp1NNode";
...
void QryBrlyFltEqp1NNode::StgIac::writeXML(
	...
	else itemtag = "StgitemIacQryBrlyFltEqp1NNode";
...
set<uint> QryBrlyFltEqp1NNode::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyFltEqp1NNode::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
