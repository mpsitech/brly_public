/**
  ...
  * API code for job QryBrlyUsgMNUser (implementation)
...
/******************************************************************************
 class QryBrlyUsgMNUser::StatApp
 ******************************************************************************/

QryBrlyUsgMNUser::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyUsgMNUser::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyUsgMNUser";
...
set<uint> QryBrlyUsgMNUser::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyUsgMNUser::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyUsgMNUser::StatShr
 ******************************************************************************/

QryBrlyUsgMNUser::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyUsgMNUser::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyUsgMNUser";
...
set<uint> QryBrlyUsgMNUser::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyUsgMNUser::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyUsgMNUser::StgIac
 ******************************************************************************/

QryBrlyUsgMNUser::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyUsgMNUser::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyUsgMNUser";
...
void QryBrlyUsgMNUser::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyUsgMNUser";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyUsgMNUser";
...
set<uint> QryBrlyUsgMNUser::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyUsgMNUser::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
