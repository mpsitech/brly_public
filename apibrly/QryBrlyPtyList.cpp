/**
  ...
  * API code for job QryBrlyPtyList (implementation)
...
/******************************************************************************
 class QryBrlyPtyList::VecVOrd
 ******************************************************************************/

uint QryBrlyPtyList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryBrlyPtyList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryBrlyPtyList::StatApp
 ******************************************************************************/

QryBrlyPtyList::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyPtyList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyPtyList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyPtyList";
...
set<uint> QryBrlyPtyList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyPtyList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyPtyList::StatShr
 ******************************************************************************/

QryBrlyPtyList::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyPtyList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyPtyList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyPtyList";
...
set<uint> QryBrlyPtyList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyPtyList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyPtyList::StgIac
 ******************************************************************************/

QryBrlyPtyList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyPtyList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyPtyList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyPtyList";
...
void QryBrlyPtyList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyPtyList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyPtyList";
...
set<uint> QryBrlyPtyList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyPtyList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
