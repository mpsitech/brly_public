/**
  ...
  * API code for job PnlBrlyLocBgn1NLeg (declarations)
...
namespace PnlBrlyLocBgn1NLeg {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryBrlyLocBgn1NLeg::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryBrlyLocBgn1NLeg::StatApp statappqry;
