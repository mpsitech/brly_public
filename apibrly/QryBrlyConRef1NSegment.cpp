/**
  ...
  * API code for job QryBrlyConRef1NSegment (implementation)
...
/******************************************************************************
 class QryBrlyConRef1NSegment::StatApp
 ******************************************************************************/

QryBrlyConRef1NSegment::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyConRef1NSegment::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyConRef1NSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyConRef1NSegment";
...
set<uint> QryBrlyConRef1NSegment::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyConRef1NSegment::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyConRef1NSegment::StatShr
 ******************************************************************************/

QryBrlyConRef1NSegment::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyConRef1NSegment::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyConRef1NSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyConRef1NSegment";
...
set<uint> QryBrlyConRef1NSegment::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyConRef1NSegment::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyConRef1NSegment::StgIac
 ******************************************************************************/

QryBrlyConRef1NSegment::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyConRef1NSegment::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyConRef1NSegment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyConRef1NSegment";
...
void QryBrlyConRef1NSegment::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyConRef1NSegment";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyConRef1NSegment";
...
set<uint> QryBrlyConRef1NSegment::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyConRef1NSegment::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
