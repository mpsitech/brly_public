/**
  * \file PnlBrlySegHeadbar.h
  * API code for job PnlBrlySegHeadbar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 8 Jan 2018
  * \date modified: 8 Jan 2018
  */

#ifndef PNLBRLYSEGHEADBAR_H
#define PNLBRLYSEGHEADBAR_H

#include "ApiBrly_blks.h"

#define StgInfBrlySegHeadbar PnlBrlySegHeadbar::StgInf
#define TagBrlySegHeadbar PnlBrlySegHeadbar::Tag

#define DpchEngBrlySegHeadbarData PnlBrlySegHeadbar::DpchEngData

/**
  * PnlBrlySegHeadbar
  */
namespace PnlBrlySegHeadbar {
	/**
	  * StgInf (full: StgInfBrlySegHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngBrlySegHeadbarData)
		*/
