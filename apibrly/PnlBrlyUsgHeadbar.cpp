/**
  ...
  * API code for job PnlBrlyUsgHeadbar (implementation)
...
/******************************************************************************
 class PnlBrlyUsgHeadbar::StgInf
 ******************************************************************************/

PnlBrlyUsgHeadbar::StgInf::StgInf(
...
bool PnlBrlyUsgHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfBrlyUsgHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfBrlyUsgHeadbar";
...
set<uint> PnlBrlyUsgHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlBrlyUsgHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlBrlyUsgHeadbar::Tag
 ******************************************************************************/

PnlBrlyUsgHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlBrlyUsgHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagBrlyUsgHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemBrlyUsgHeadbar";
...
/******************************************************************************
 class PnlBrlyUsgHeadbar::DpchEngData
 ******************************************************************************/

PnlBrlyUsgHeadbar::DpchEngData::DpchEngData() : DpchEngBrly(VecBrlyVDpch::DPCHENGBRLYUSGHEADBARDATA) {
};

string PnlBrlyUsgHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlBrlyUsgHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngBrlyUsgHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
