/**
  ...
  * API code for job QryBrlyPty1NEquipment (implementation)
...
/******************************************************************************
 class QryBrlyPty1NEquipment::StatApp
 ******************************************************************************/

QryBrlyPty1NEquipment::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyPty1NEquipment::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyPty1NEquipment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyPty1NEquipment";
...
set<uint> QryBrlyPty1NEquipment::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyPty1NEquipment::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyPty1NEquipment::StatShr
 ******************************************************************************/

QryBrlyPty1NEquipment::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyPty1NEquipment::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyPty1NEquipment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyPty1NEquipment";
...
set<uint> QryBrlyPty1NEquipment::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyPty1NEquipment::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyPty1NEquipment::StgIac
 ******************************************************************************/

QryBrlyPty1NEquipment::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyPty1NEquipment::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyPty1NEquipment");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyPty1NEquipment";
...
void QryBrlyPty1NEquipment::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyPty1NEquipment";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyPty1NEquipment";
...
set<uint> QryBrlyPty1NEquipment::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyPty1NEquipment::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
