/**
  * \file QryBrlyLocEqp1NNode.cpp
  * API code for job QryBrlyLocEqp1NNode (implementation)
...
/******************************************************************************
 class QryBrlyLocEqp1NNode::StatApp
 ******************************************************************************/

QryBrlyLocEqp1NNode::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyLocEqp1NNode::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyLocEqp1NNode");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyLocEqp1NNode";
...
set<uint> QryBrlyLocEqp1NNode::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocEqp1NNode::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLocEqp1NNode::StatShr
 ******************************************************************************/

QryBrlyLocEqp1NNode::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyLocEqp1NNode::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyLocEqp1NNode");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyLocEqp1NNode";
...
set<uint> QryBrlyLocEqp1NNode::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocEqp1NNode::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyLocEqp1NNode::StgIac
 ******************************************************************************/

QryBrlyLocEqp1NNode::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyLocEqp1NNode::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyLocEqp1NNode");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyLocEqp1NNode";
...
void QryBrlyLocEqp1NNode::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyLocEqp1NNode";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyLocEqp1NNode";
...
set<uint> QryBrlyLocEqp1NNode::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyLocEqp1NNode::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
