/**
  ...
  * API code for job PnlBrlyLocEqpMNConnection (declarations)
...
/**
  ...
  */
namespace PnlBrlyLocEqpMNConnection {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryBrlyLocEqpMNConnection::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryBrlyLocEqpMNConnection::StatApp statappqry;
