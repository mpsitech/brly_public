/**
  ...
  * API code for job QryBrlyRegADstswitch (implementation)
...
/******************************************************************************
 class QryBrlyRegADstswitch::StatApp
 ******************************************************************************/

QryBrlyRegADstswitch::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyRegADstswitch::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyRegADstswitch");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyRegADstswitch";
...
set<uint> QryBrlyRegADstswitch::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyRegADstswitch::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyRegADstswitch::StatShr
 ******************************************************************************/

QryBrlyRegADstswitch::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyRegADstswitch::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyRegADstswitch");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyRegADstswitch";
...
set<uint> QryBrlyRegADstswitch::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyRegADstswitch::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyRegADstswitch::StgIac
 ******************************************************************************/

QryBrlyRegADstswitch::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyRegADstswitch::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyRegADstswitch");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyRegADstswitch";
...
void QryBrlyRegADstswitch::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyRegADstswitch";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyRegADstswitch";
...
set<uint> QryBrlyRegADstswitch::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyRegADstswitch::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
