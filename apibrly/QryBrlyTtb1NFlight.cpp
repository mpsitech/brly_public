/**
  * \file QryBrlyTtb1NFlight.cpp
  * API code for job QryBrlyTtb1NFlight (implementation)
...
/******************************************************************************
 class QryBrlyTtb1NFlight::StatApp
 ******************************************************************************/

QryBrlyTtb1NFlight::StatApp::StatApp(
			const uint firstcol
...
bool QryBrlyTtb1NFlight::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryBrlyTtb1NFlight");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryBrlyTtb1NFlight";
...
set<uint> QryBrlyTtb1NFlight::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyTtb1NFlight::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyTtb1NFlight::StatShr
 ******************************************************************************/

QryBrlyTtb1NFlight::StatShr::StatShr(
			const uint ntot
...
bool QryBrlyTtb1NFlight::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryBrlyTtb1NFlight");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryBrlyTtb1NFlight";
...
set<uint> QryBrlyTtb1NFlight::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyTtb1NFlight::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryBrlyTtb1NFlight::StgIac
 ******************************************************************************/

QryBrlyTtb1NFlight::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryBrlyTtb1NFlight::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryBrlyTtb1NFlight");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryBrlyTtb1NFlight";
...
void QryBrlyTtb1NFlight::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryBrlyTtb1NFlight";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryBrlyTtb1NFlight";
...
set<uint> QryBrlyTtb1NFlight::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryBrlyTtb1NFlight::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
